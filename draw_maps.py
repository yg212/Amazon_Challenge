...
def generate_maps_for_routes(sorted_routes, packages, score_category, limit=20):
    ...
    maps_dir = f"map/allmaps/{score_category}"
...
generate_maps_for_routes(sort_high_score_routes, packages, 'High', 60)
